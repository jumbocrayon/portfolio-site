...
import PokeMeBox from "@/demos/PokeMeBox";

/**
 * The seeded Workbench.
 *
 * Two entries for v0, both rendering through the real Experiment type and
 * components. The pre-mortem worksheet borrows the trivial PokeMeBox demo for
...
export const experiments: Experiment[] = [
  {
    ...
    depth: {
      ...
      howItWorks:
        "A told moment is parsed into a beat, a cast, and a camera. The art direction stays human-defined (my hand sets the style); the AI fills the in-betweens in real time against those constraints. Originates as a Familiar feature — a playthrough's story becomes a shareable vignette.",
      systems:
        "The interesting problem isn't the model, it's the guardrails: how do you let AI animate freely while keeping a consistent, human-authored style? The answer is a constraint layer that treats art direction as a first-class input, not a post-hoc filter. Same build wears three hats — feature, demo, and dev-blog content.",
    },
